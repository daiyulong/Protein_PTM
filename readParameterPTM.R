...
if(FALSE){
  inputPara<-'E:/projectResearch/02磷酸化蛋白组学流程/demo_parameter.xlsx'
  input<-'E:/projectResearch/02磷酸化蛋白组学流程/parameterResult/1.Info/matrix.txt'
